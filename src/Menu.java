...
public class Menu {
    ...
    public static void printOnlyThisClass(Farm<Animal> animalFarm) {
        ...
        switch (userSelectedClass) {
            case 1 -> animalFarm.printOnlyThisClass(1);
            case 2 -> animalFarm.printOnlyThisClass(2);
        }
    }
    ...
    public static void Comands(){
        ...
        switch (userSelectedClass) {
            ...
            case 2 -> {
                ...
                userSelected = scanner.nextInt();
                switch (userSelected) {
                    case 1 -> Camel.Comands();
                    case 2 -> Donkey.Comands();
                    case 3 -> Horse.Comands();
                }
            }
        }
